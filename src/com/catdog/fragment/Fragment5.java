...
public class Fragment5 extends Fragment implements OnClickListener {
	private View tab5;
	private LinearLayout ll_add, ll_info, fragment5_ll_myorder,
			fragment5_ll_mycollect;
	private LinearLayout ll_contact, ll_public, ll_check_update;
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		preferencesManager = new SharePreferencesManager(getActivity(),
	...
	private void requestInfo() {
		...
		HttpUtils.getDataFromVolley(getActivity(), URLConstant.USER_HEAD, null,
				map, listener);
	}
	...
	private void initView() {
		...
		ll_check_update = (LinearLayout) tab5
				.findViewById(R.id.meFt_ll_check_update);
		fragment5_ll_myorder = (LinearLayout) tab5
				.findViewById(R.id.fragment5_ll_myorder);
		fragment5_ll_mycollect = (LinearLayout) tab5
				.findViewById(R.id.fragment5_ll_mycollect);
		tv_name.setText(getUserUid());
	}
	...
	public void onClick(View v) {
		...
		case R.id.meFt_ll_public:
			...
			break;
		case R.id.meFt_ll_check_update:
			LogUtil.showInstanceToast(R.string.checking_update, getActivity());
