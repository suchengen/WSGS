...
import com.catdog.fragment.SearchAtivity.Historyadapter;
import com.catdog.fragment.SearchAtivity.HotSearchadapter;
...
public class Fragment3 extends Fragment implements OnRefreshListener2<GridView>{
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		tab3 = inflater.inflate(R.layout.main_fragment3, container,false);
		initView();
		hotsearch();
	...
	private void hotsearch() {
		...
		VolleyHttpClient.getInstance(getActivity()).post(url, params, null, new Listener<String>() {
			@Override
	...
	public void onResume() {
		super.onResume();
		sharePreferenceUtil = new SharePreferenceUtil(getActivity(), "users");
		...
		search_delete.setOnClickListener(new OnClickListener() {
			...
			@Override
			public void onClick(View v) {
				sharePreferenceUtil.remove(getActivity(), "search");
	...
	private void initView() {
		fragment3_ll_search = (LinearLayout) tab3.findViewById(R.id.fragment3_ll_search);
		fragment3_class_gv = (PullToRefreshGridView) tab3.findViewById(R.id.fragment3_class_gv);
		...
		imageView2 = (ImageView) tab3.findViewById(R.id.imageView2);
		editText1 = (EditText) tab3.findViewById(R.id.editText1);
		fragment3_gridview_history = (GridView) tab3.findViewById(R.id.fragment3_gridview_history);
		fragment3_gridview_hotsearch = (GridView) tab3.findViewById(R.id.fragment3_gridview_hotsearch);
		search_delete = (Button) tab3.findViewById(R.id.search_delete);
	}
	private void requestClass(int row,int currentpage,String text) {
		...
		HttpUtils.getDataFromVolley(getActivity(), URLConstant.TWO_CLASSIFY, null, map, twoListener);
	}
	...
	private ResponseListener twoListener = new ResponseListener() {
		...
		public void getResponse(Object object) throws JSONException {
			...
			mAdapter = new ClassifyListAdapter(getActivity(), list_data);
